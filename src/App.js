  ...
  return (
    <div className="App">
      <header className="App-header" style={{ backgroundColor: darkMode ? '#1e1e1e' : 'white' }}>
        ...
        {darkMode ? <button style={{ float: 'right', padding: 10}}><MdDarkMode style={{ display: 'flex'}} color="white" onClick={changeTheme} /></button> : <button style={{ float: 'right', padding: 10}}><MdOutlineDarkMode color="black" onClick={changeTheme} /></button> }
        </div>
        ...
        <div className="bottom" style={{ width: isMobile ? '93%' : '40%' }}>
          {specialty ? <div style={{ marginTop: 'auto', display: 'flex', width: '100%'}}>
            <IoMdSettings size={23} color="black" style={{ width: 35, height: 35, backgroundColor: darkMode ? 'white' : '#EEEE', marginRight: 8, padding: 3, borderRadius: 4 }} />
          ...
          {chatMessages.map((item, index) => (
            ...
            <div style={{ marginTop: 'auto', width: '100%', display: 'flex', flexDirection: 'row',  justifyContent: 'flex-start', marginBottom: 20}}>
              {index % 2 === 0 ? <BsFillPersonFill size={23} color="black" style={{ width: 35, height: 35, backgroundColor: darkMode ? 'white' : '#EEEE', marginRight: 8, padding: 3, borderRadius: 4 }} /> : <img src='./logo.jpeg' style={{ width: 35, height: 35, marginRight: 8, padding: 3, borderRadius: 7}}></img>}
